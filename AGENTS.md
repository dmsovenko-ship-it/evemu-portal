...
- **Навбар-дропдауны** (`502fb3d`): открываются тап/клик через JS-класс `.open` (надёжно на мобильных), hover только для `(hover:hover) and (pointer:fine)`, закрытие по клику вне и Esc — больше не «залипают».
