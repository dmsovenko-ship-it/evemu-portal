...
<table class="kill-table">
    ...
    <?php if (empty($paginated)): ?>
        <tr><td colspan="9" class="empty">No kills recorded for this corporation</td></tr>
    <?php endif; ?>
    </tbody>
</table>
